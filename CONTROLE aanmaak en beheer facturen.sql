...
WHERE 	i.create_date > '2025-10-21 10:17:20.000000' -- 9913
...
(
	...
	FROM account_invoice i
		...
		JOIN product_product pp ON p.membership_renewal_product_id = pp.id
		JOIN res_users u ON i.create_uid = u.id
	WHERE 	--i.create_date > '2025-10-21 10:17:20.000000' 
		i.create_date > '2025-10-23 19:00:00.000000' 
