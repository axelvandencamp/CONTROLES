...
SELECT * FROM res_users WHERE id IN (186,487,432,513,260,315,292,199,302)
SELECT * FROM res_users WHERE login LIKE 'lynn.s%'
...
INSERT INTO marketing._temp_logcounter (
	...
	WHERE a.create_uid IN (186,487,432,513,260,315,292,199,302) AND a.create_date::date = v.logdatum
...
INSERT INTO marketing._temp_logcounter (
	...
	WHERE a.write_uid IN (186,487,432,513,260,315,292,199,302) AND a.write_date::date = v.logdatum
	GROUP BY u.login, v.logdatum);
