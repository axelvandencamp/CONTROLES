...
FROM payment_line pl JOIN payment_order po ON pl.order_id = po.id
WHERE po.reference IN ('2024/06335')	
SELECT * FROM payment_order po WHERE po.reference IN ('2024/06335')
SELECT * FROM payment_line pl WHERE pl.write_date::date = '2024-12-17'
--------------------------------------------------------
-- TELLER betaalde facturen (bij bevestigen 
--------------------------------------------------------
